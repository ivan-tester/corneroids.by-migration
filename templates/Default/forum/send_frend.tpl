<div style="margin-top:1px;">
  <div class="borderwrap">
    <div class="maintitle"> <img src="{THEME}/forum/images/nav_m.gif" width="8" height="8" border="0" alt="" />&nbsp;Отправка письма другу</div>
              ...
              <tr>
                <td align="left">
                  <table cellpadding="0" cellspacing="0" width="460">
                    ...
                    <tr>
                      <td width="140" height="25">Кому (имя друга):</td>
                      <td width="320"><input type="text" name="frend_name" maxlength="150" class="forum_input" /></td>
                    </tr>
                    <tr>
                      <td width="140" height="25">Отправить на (e-mail):</td>
                      <td width="320"><input type="text" name="frend_mail" maxlength="150" class="forum_input" /></td>
                    </tr>
                    <tr>
                      <td width="140" height="25">Тема:</td>
                      <td width="320"><input type="text" name="frend_title" maxlength="150" value="{topic_title}" class="forum_input" /></td>
                    </tr>
                    <tr>
                      <td width="140" height="25">Сообщение:</td>
                      <td width="320"><textarea name="frend_text" style="width:320px; height:120px" rows="" cols="" class="forum_textarea">Я думаю, это нужно прочитать:
{topic_link}

С уважением, {user_name}</textarea></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><br /><input name="submit" type="submit" class="button" value="Отправить" /></td>
                    </tr>
                  </table>
                </td>
              </tr>
