<div style="margin-top:1px;">
  <div class="borderwrap">
    <div class="maintitle"> <img src="{THEME}/forum/images/nav_m.gif" width="8" height="8" border="0" alt="" />&nbsp;Отправить модератору жалобу на это сообщение</div>
              ...
              <tr>
                <td align="left">
                  <table cellpadding="0" cellspacing="0" width="460">
                    ...
                    <tr>
                      <td width="120" height="25">Введите текст жалобы:</td>
                    ...
                    <tr>
                      <td width="120">&nbsp;</td>
                      <td width="340"><input name="submit" type="submit" class="button" value="Отправить" /></td>
                    </tr>
                  </table>
                </td>
              </tr>
