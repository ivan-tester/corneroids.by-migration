<div style="margin-top:1px;">
  <div class="polltitle"> <img src="{THEME}/forum/images/nav_m.gif" width="8" height="8" border="0" alt="" />&nbsp;{vote_title}</div>
    <table width="100%" cellspacing="1" cellpadding="0">
              ...
              <tr>
                <td align="center">
                  <table cellpadding="0" cellspacing="0" width="460">
                    ...
                    <tr>
                      <td align="center"><br /><strong>Всего проголосовало: {vote_count}</strong><br /><br /></td>
                    </tr>
                  </table>
                </td>
              </tr>
      ...
      <tr>
        <td class="formbuttonrow" align="center"><input type="button" class="button" onclick="doPoll('vote'); return false;" value="Голосовать" />&nbsp;<input type="button" class="button" onclick="doPoll('results'); return false;" value="Результаты" /></td>
      </tr>
      <tr>
