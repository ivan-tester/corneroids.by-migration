...
[not-logged]
                    <tr>
                      <td width="80" height="24">Ваше Имя:</td>
...
[/sec_code]
				  ...
				  <input name="submit" type="submit" class="button" value="Отправить" />&nbsp;<input type="button" class="button" onclick="PostPreview();" value="Просмотр" />
                </td>
              </tr>
            </table>
          </div>
