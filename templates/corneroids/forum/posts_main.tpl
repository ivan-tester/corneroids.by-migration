...
<div class="borderwrap">
  <div class="maintitle">
    <table width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td width="99%"><div><img src="{THEME}/forum/images/nav_m.gif" width="8" height="8" border="0" alt="" />&nbsp;Сообщения пользователя: {user_name}</div></td>
      </tr>
    </table>
  </div>
{posts}
<table width="100%" cellspacing="1" cellpadding="0" class="ipbtable">
    <tr>
      <td class="row1"><div align="right">{post_moderation}</div></td>
    </tr>
</table>
</div>
<div>{navigation}</div>