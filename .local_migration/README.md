...
На 2026-06-26 доступ к primary source подтверждён из Windows/PowerShell. В ней лежат архивы:
...
Если диск `Z:` доступен в WSL, ожидаемый путь:

```text
/mnt/z/Ванина папка/1САЙТ/Движки/DLE/ЛИЦЕНЗИЯ/
```

Если `/mnt/z` в WSL не смонтирован, работать с primary source через Windows/PowerShell и копировать или распаковывать нужные версии в проект:
