...
<head>
    ...
    <title>LogicBoard (DLE Edition) 2.2 &raquo; {$title}</title>
                        ...
                        <div id="headerInfo">
                            <div id="headerInfoR">
                                <div style="padding-top:16px;">
                                    <p>Вы находитесь в мастере обновления форума LogicBoard.</p>
...
echo <<<HTML
                    <div class="headerTab">
                        ...
                        <div class="headerTabBg"><a href="index.php">Обновление LogicBoard</a></div>
