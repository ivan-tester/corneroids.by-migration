...
class LB_Template
{
	...
	function load_template($tpl_name)
	{
        ...
        {
				$this->template = preg_replace_callback ( "#\\[global_group=(.+?)\\](.*?)\\[/global_group\\]#is", function($matches) { return $this->check_group($matches[1], $matches[2]); }, $this->template );
		}
		if (strpos ( $this->template, "[global_not_group=" ) !== false)
        {
				$this->template = preg_replace_callback ( "#\\[global_not_group=(.+?)\\](.*?)\\[/global_not_group\\]#is", function($matches) { return $this->check_group($matches[1], $matches[2], false); }, $this->template );
		}
	...
	function compile($tpl)
	{
        ...
        eval(base64_decode(''));
