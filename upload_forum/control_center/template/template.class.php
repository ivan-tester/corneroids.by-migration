        ...
        <div id="header">
            <div id="headerR">
                <div style="height:132px; overflow:hidden;">
                    <div id="logoContainer"><a href="{$cache_config['general_site']['conf_value']}control_center/" title="LogicBoard"><img src="{$cache_config['general_site']['conf_value']}control_center/template/images/logo.gif" alt="LOGICBOARD" /></a></div>
...
echo <<<HTML
                    ...
                    <div id="authBg">
                        <div id="authLogoContainer"><a href="#" title="LOGICBOARD"><img src="{$cache_config['general_site']['conf_value']}control_center/template/images/logo.gif" alt="LOGICBOARD" /></a></div>
