...
$link_speddbar = "<a href=\"".$redirect_url."?do=board\">Форум</a>|<a href=\"".$redirect_url."?do=board&op=sharelink\">Сервисы публикации</a>|Добавление";
$control_center->header("Форум", $link_speddbar);
$onl_location = "Форум &raquo; Сервисы публикации &raquo; Добавление";
...
if (isset($_POST['newemail']))
{
	...
	if (!$control_center->errors)
	{
		...
		$info = "<font color=green>Добавление</font> сервиса публикации: ".$title;
...
<form  method="post" name="newpage" action="">
                    ...
                    <div class="headerGray">
                        ...
                        <div class="headerGrayBg">Добавление сервиса публикации</div>
                    </div>
                    <div class="borderL">
                        <div class="borderR">
                           <table>
                                <tr>
                                    <td align=left>
                                        ...
                                        <div>
                                            ...
                                            <div>
                        						<div class="radioContainer"><input name="send_url" type="radio" id="send_url_1" value="1"></div> <label class="radioLabel" for="send_url_1">Да</label>
                        						<div class="radioContainer optionFalse"><input name="send_url" type="radio" id="send_url_0" value="0" checked></div> <label class="radioLabel" for="send_url_0">Нет</label>
                    					    </div>
                                        </div>
                                        <div class="clear" style="height:18px;"></div>
                                        <div>
                                            ...
                                            <div>
                        						<div class="radioContainer"><input name="active_status" type="radio" id="active_status_1" value="1" checked></div> <label class="radioLabel" for="active_status_1">Да</label>
                        						<div class="radioContainer optionFalse"><input name="active_status" type="radio" id="active_status_0" value="0"></div> <label class="radioLabel" for="active_status_0">Нет</label>
                    					    </div>
                                        </div>
                                        <div class="clear" style="height:18px;"></div>
                                        <div>
